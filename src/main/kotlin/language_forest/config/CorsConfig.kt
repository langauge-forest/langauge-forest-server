...
class CorsConfig {
    ...
    fun corsConfigurationSource(): CorsConfigurationSource {
        ...
        config.allowedOrigins = listOf("http://localhost:3000", "http://localhost:8080", "https://dev.languageforest.in", "https://www.languageforest.in", "https://languageforest.in") // 허용할 Origin 추가
